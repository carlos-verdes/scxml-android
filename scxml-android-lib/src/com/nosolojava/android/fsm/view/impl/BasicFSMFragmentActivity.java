...
public abstract class BasicFSMFragmentActivity extends FragmentActivity implements FSMActivityIntegration {

	protected final FSMActivityIntegrationHelper fsmHelper;


	public BasicFSMFragmentActivity(Class<? extends Service> fsmServiceClazz, int viewId, Uri fsmUri) {
		super();
